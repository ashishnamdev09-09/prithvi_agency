...
<body>
		...
		<tr>
		        ...
		        <td colspan="9"><center>Product Details</center>
			...
			<?php
			  ...
			  <tr>
			 		<td><?php echo $sno++;?></td>
			  		...
			  		<td><a href="product_details_edit.php?id=<?php echo $row["pd_id"];?>">EDIT</a></td>
			  		<td><a href="product_details_delete.php?id=<?php echo $row["pc_id"];?>">DELETE</a></td>
			  </tr>
			  <?php
			}
			?>
